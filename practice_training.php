...
<body class="bg">
	...
	<div class="card_opa">
		...
		<div class="col-sm-12 d-flex justify-content-center">
			<p class="h3 mt-2">For Practice Training</p>
		</div>
		<div class="col-sm-12">
...
<script>
	...
	function search_all(){
		...
		xhttp.open("GET", "AJAX/query_practice.php?operation=search_all", true);
		xhttp.send();
	}
	function search_practice(){
		...
		xhttp.open("GET", "AJAX/query_practice.php?operation=search_key&&keyword="+keyword, true);
		xhttp.send();
	}
	function open_details(x){
		...
		xhttp.open("GET", "AJAX/query_practice.php?operation=search_details_sus&&id_no="+x, true);
		xhttp.send()
	...
	function btn_save_status_function(){
		...
		xhttp.open("GET", "AJAX/save_practice.php?operation=save&&id_no="+id_no+"&&process_dropdown="+process_dropdown+"&&pt_section_select="+pt_section_select+"&&process_under="+process_under+"&&date_of_training="+date_of_training+"&&name_trainor="+name_trainor, true);		
		xhttp.send()
	}
	function download_excel(){
		window.open("AJAX/download_excel/for_practice_training.php" , '_blank');
	}
</script>
<!-- JQuery -->
