...
<body class="bg">
	...
	<div class="card_opa">
		...
		<div class="col-sm-12 d-flex justify-content-center">
			<p class="h3 mt-2" id="for_or_ongoing_title" >For Refresh Training</p>
		</div>
		<div class="col-sm-12">
...
<script>
	...
	function search_all(){
		...
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_all", true);
		xhttp.send();
	}
	function search_refresh(){
		...
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_keyword&&keyword="+keyword, true);
		xhttp.send();
	}
	function open_details(x){
		...
		xhttp.onreadystatechange = function(){
			if (this.readyState == 4 && this.status == 200){
				...
				document.getElementById('id_no_cc').value=x;
			}
		};
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_details_sus&&id_no="+x, true);
		xhttp.send()
	...
	function download_excel(){
		window.open("AJAX/download_excel/for_refresh_training.php", '_blank');
	}
</script>
<!-- JQuery -->
