...
if($operation == "search_all"){
	$sql = "SELECT * FROM cc_or_refresh WHERE status = 'Refresh Training' ORDER BY id DESC";
...
else if($operation == "search_all_ongoing"){ // For Ongoing Refresh Training
	$sql1 = "SELECT id, id_no, process_final_initial, practice_training, process_under FROM refresh_training_details WHERE status='Ongoing' ORDER BY id DESC";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0){
		while($row1 = $result1->fetch_assoc()){
			$id1 = $row1['id'];
...
else if($operation == "search_all_completed"){ // For Completed Refresh Training
	$sql1 = "SELECT id, id_no, process_final_initial, practice_training, process_under FROM refresh_training_details WHERE status='Completed' ORDER BY id DESC";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0){
		while($row1 = $result1->fetch_assoc()){
			$id1 = $row1['id'];
...
else if($operation == "search_all_incomplete"){ // For Incomple in Refresh Training
...
else if($operation == "search_keyword_ongoing"){ // For Searching All Ongoing Refresh Training
	$keyword = mysqli_real_escape_string($conn, $_GET['keyword']);	
	$sql1 = "SELECT id, id_no, process_final_initial, practice_training, process_under FROM refresh_training_details WHERE status='Ongoing' AND (id_no LIKE '%$keyword%' OR process_final_initial LIKE '%$keyword%' OR practice_training LIKE '%$keyword%' OR process_under LIKE '%$keyword%') ORDER BY id DESC";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0){
		while($row1 = $result1->fetch_assoc()){
			$id1 = $row1['id'];
...
else if($operation == "search_keyword_completed"){ // For Searching All Completed in Refresh Training
	$keyword = mysqli_real_escape_string($conn, $_GET['keyword']);	
	$sql1 = "SELECT id, id_no, process_final_initial, practice_training, process_under FROM refresh_training_details WHERE status='Completed' AND (id_no LIKE '%$keyword%' OR process_final_initial LIKE '%$keyword%' OR practice_training LIKE '%$keyword%' OR process_under LIKE '%$keyword%') ORDER BY id DESC";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0){
		while($row1 = $result1->fetch_assoc()){
			$id1 = $row1['id'];
...
else if($operation == "search_keyword_incomplete"){ // For Searching All Incomplete in Refresh Training
	$keyword = mysqli_real_escape_string($conn, $_GET['keyword']);	
	$sql1 = "SELECT id, id_no, process_final_initial, practice_training, process_under FROM refresh_training_details WHERE status='Incomplete' AND (id_no LIKE '%$keyword%' OR process_final_initial LIKE '%$keyword%' OR practice_training LIKE '%$keyword%' OR process_under LIKE '%$keyword%') ORDER BY id DESC";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0){
		while($row1 = $result1->fetch_assoc()){
			$id1 = $row1['id'];
...
else if($operation == "get_history_process"){
	$id_no = mysqli_real_escape_string($conn, $_GET['id_no']);	
	$sql = "SELECT * FROM ir_memo WHERE id_no ='$id_no' ORDER BY id DESC";
	$result = $conn->query($sql);
	if ($result->num_rows > 0){
