...
<body class="bg">
	...
	<div class="card_opa">
		...
		<div class="col-sm-12 d-flex justify-content-center">
			<p class="h3 mt-2" id="for_or_ongoing_title" >Ongoing Refresh Training</p>
		</div>
		<div class="col-sm-12">
...
<script>
	search_all(); // For Viewing All Ongoing Refresh Training
	function search_all(){ // For Viewing All Ongoing Refresh Training
		...
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_all_ongoing", true);
		xhttp.send();
	}
	function search_refresh(){ // For Searching All Ongoing Refresh Training
		...
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_keyword_ongoing&&keyword="+keyword, true);
		xhttp.send();
	}
	function open_details(x){
		...
		document.getElementById('date_completed_section').style.display="inline-block";
		document.getElementById('process_dropdown').style.display="none";
		document.getElementById('title_modal_head').innerHTML="Ongoing Refresh Training"; // To Change the Title on the Header of Modal
	...
	function display_none_details(){
		...
		document.getElementById('process_dropdown').style.display="none";
		document.getElementById('date_completed_section').style.display="none";
	...
	function btn_save_status_function(){
		...
		xhttp.open("GET", "AJAX/save_refresh.php?operation=update_result&&id_no="+id_no+"&&id="+id+"&&pt_section_result="+pt_section_result+"&&name_trainor="+name_trainor+"&&date_completed="+date_completed, true);
		xhttp.send()
	}
	function download_excel(){
		window.open("AJAX/download_excel/ongoing_refresh_training.php?operation=ongoing_refresh_training" , '_blank');
	}
</script>
<!-- JQuery -->
