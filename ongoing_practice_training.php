...
<body class="bg">
	...
	<div class="card_opa">
		...
		<div class="col-sm-12 d-flex justify-content-center">
			<p class="h3 mt-2">Ongoing Practice Training</p>
		</div>
		<div class="col-sm-12">
...
<script>
	...
	function search_all(){
		...
		xhttp.open("GET", "AJAX/query_practice.php?operation=search_all_ongoing", true);
		xhttp.send();
	}
	function search_practice(){
		...
		xhttp.open("GET", "AJAX/query_practice.php?operation=search_key_ongoing&&keyword="+keyword, true);
		xhttp.send();
	}
	function open_details(x){
		...
		document.getElementById('title_modal_head').innerHTML="Ongoing Practice Training"; // To Change the Title on the Header of Modal
	...
	function btn_save_status_function(){
		...
		xhttp.open("GET", "AJAX/save_practice.php?operation=update_result&&id_no="+id_no+"&&id="+id+"&&pt_section_result="+pt_section_result+"&&name_trainor="+name_trainor+"&&date_completed="+date_completed, true);
		xhttp.send()
	}
	function download_excel(){
		window.open("AJAX/download_excel/ongoing_practice_training.php" , '_blank');
	}
</script>
<!-- JQuery -->
