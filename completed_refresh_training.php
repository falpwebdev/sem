...
<body class="bg">
	...
	<div class="card_opa">
		...
		<div class="col-sm-12 d-flex justify-content-center">
			<p class="h3 mt-2" id="for_or_ongoing_title" >Completed in Refresh Training</p>
		</div>
		<div class="col-sm-12">
...
<script>
	search_all();// For Viewing All Completed in Refresh Training
	function search_all(){// For Viewing All Completed in Refresh Training
		...
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_all_completed", true);
		xhttp.send();
	}
	function search_refresh(){ // For Searching All Completed in Refresh Training
		...
		xhttp.open("GET", "AJAX/query_refresh.php?operation=search_keyword_completed&&keyword="+keyword, true);
		xhttp.send();
	}
	...
	function download_excel(){
		window.open("AJAX/download_excel/completed_refresh_training.php" , '_blank');
	}
</script>
<!-- JQuery -->
