	...
	<div class="modal-dialog modal-fluid">
		<div class="modal-content">
			<div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold grey-text" id="title_modal_head">For Practice Training</h4>
			...
			<div class="modal-body row">
				...
				<div class="row col-sm-10">
					<div id="id_no_section" class="md-form mb-0 col-sm-4" style="display:none;">
						<input type="hidden" id="hidden_id_table" class="form-control text-center">
			...
			<div class="row ml-0 mr-3">
				<div id="date_completed_section" class="md-form mb-0 col-sm-3" style="display:none;">
					<input type="date" id="date_completed" class="form-control text-center">
				...
				<div id="trainor_section" class="md-form mb-0 col-sm-3" style="display:none;">
					<input type="text" id="name_trainor" value=" " class="form-control text-center">
